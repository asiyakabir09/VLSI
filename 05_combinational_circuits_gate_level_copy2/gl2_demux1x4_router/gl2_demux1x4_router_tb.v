module gl2_demux1x4_router_tb;
    reg d,s1,s0; wire y0,y1,y2,y3;
    gl2_demux1x4_router dut(d,s1,s0,y0,y1,y2,y3);
    initial begin $fsdbDumpfile("dump.fsdb"); $fsdbDumpvars(0, gl2_demux1x4_router_tb); end
