module gl2_encoder4_to_2_unit_tb;
    reg i0,i1,i2,i3; wire y1,y0;
    gl2_encoder4_to_2_unit dut(i0,i1,i2,i3,y1,y0);
    initial begin $fsdbDumpfile("dump.fsdb"); $fsdbDumpvars(0, gl2_encoder4_to_2_unit_tb); end
